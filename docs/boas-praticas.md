...
Transformar a implantacao em rotina previsivel, com seguranca minima e baixa dependencia de conhecimento tacito.
...
- desabilite autenticacao por senha no SSH quando o fluxo por chave estiver validado.
...
- documentacao desatualizada apos mudanca de fluxo.
- segredos fora de cofre e expostos em historico de commit.
- ausencia de responsavel por validacao pos-deploy.
